# Widget para gestionar notas de empresa
...
class NotasEmpresaWidget(QWidget):

    def __init__(self, empresa_id, usuario_actual_id, parent=None):
        super().__init__(parent)
        uic.loadUi(UI_PATH, self)
        self._empresa_id = empresa_id
        self._usuario_actual_id = usuario_actual_id
        self._nota_service = NotaEmpresaService()
    ...
    def _cargar_tabla_notas(self):
        ...
        try:
            notas, error = self._nota_service.obtener_por_empresa(self._empresa_id)
            if error:
