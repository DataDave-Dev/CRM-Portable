...
class VentasView(QWidget):
    ...
    def _limpiar_formulario_oportunidad(self):
        ...
        self.op_input_fecha_cierre_estimada.setDate(QDate.currentDate())
        self.op_combo_estado.setCurrentIndex(0)
        self.op_input_fecha_cierre_real.setDate(QDate.currentDate())
    ...
    def _limpiar_formulario_cotizacion(self):
        ...
        self.cot_input_fecha_vigencia.setDate(QDate.currentDate())
